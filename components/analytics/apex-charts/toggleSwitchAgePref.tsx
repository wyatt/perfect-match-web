...
const AgePrefToggle = () => {
    ...
    return (
        <div>
            <button className="text-base sm:text-lg text-gray-500 border border-solid border-gray-500 hover:bg-gray-100 rounded p-3 mx-[3%] sm:mx-0" onClick={() => toggleShow(!female)}>
